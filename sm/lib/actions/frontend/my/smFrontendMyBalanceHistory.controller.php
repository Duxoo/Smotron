...
class smFrontendMyBalanceHistoryController extends waJsonController
{
    public function execute()
    {
		...
		$balance_history_model = new smUserBalanceHistoryModel();
		$result = $balance_history_model->getFrontendHistory($start, $length, $order, $column, $direction, $search, $user_id);
