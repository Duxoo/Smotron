...
class smClientsListController extends waJsonController
{
    public function execute()
    {
        ...
        $clients_model = new smUserModel();
        $result = $clients_model->listEntities($start, $length, $order, $column, $direction, $search);
