        ...
        getMethod: function(args, scope, name) {
            ...
            if (args.length) {
                ...
                while (chunk = args.shift()) {
                    ...
                    $.sm.trace('$.getMethod try', [name, callable, args]);
                    if (callable === true) {
                        method.name = name;
        ...
        helper: {
            ...
            print: function(el) {
                ...
                if ($body.find('.map[id^="yandex-map"]').length) {
                    ...
                    $head.append('<script src="'+$.sm.options.jquery_url+'"></script>');
                    wnd.ymaps = undefined;
                }
